...
#ifndef TRAIN_WITH_ME_WATCH_WATCH_APP_SWIFT_H
#define TRAIN_WITH_ME_WATCH_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Train_with_Me_Watch_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC29Train_with_Me_Watch_Watch_App9WatchSync")
@interface WatchSync : NSObject <WCSessionDelegate>
